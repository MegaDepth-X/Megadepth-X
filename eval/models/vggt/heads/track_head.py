...
class TrackHead(nn.Module):
    ...
    def forward(self, aggregated_tokens_dict, images, patch_start_idx, query_points=None, iters=None):
        """
        Forward pass of the TrackHead.

        Args:
            aggregated_tokens_dict (dict): List of aggregated tokens from the backbone.
        ...
        feature_maps = self.feature_extractor(aggregated_tokens_dict, images, patch_start_idx)
